...
router.get('/', requireAuth, requireRole('admin', 'hotel_manager', 'receptionist'), listBookings);
...
router.post('/:id/checkin', requireAuth, requireRole('admin', 'hotel_manager', 'receptionist'), checkIn);
router.post('/:id/checkout', requireAuth, requireRole('admin', 'hotel_manager', 'receptionist'), checkOut);
