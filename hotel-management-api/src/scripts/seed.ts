...
const seed = async (): Promise<void> => {
  ...
  const users = await UserModel.insertMany([
    { name: 'Aarav Mehta', email: 'admin@staywise.com', phone: '9876500001', passwordHash, role: 'admin', isVerified: true },
    { name: 'Naina Kapoor', email: 'manager@staywise.com', phone: '9876500002', passwordHash, role: 'hotel_manager', isVerified: true },
    { name: 'Rohit Sharma', email: 'reception@staywise.com', phone: '9876500003', passwordHash, role: 'receptionist', isVerified: true },
    { name: 'Pooja Singh', email: 'cleaning@staywise.com', phone: '9876500004', passwordHash, role: 'cleaning_staff', isVerified: true },
    { name: 'Ishita Verma', email: 'guest@staywise.com', phone: '9876500005', passwordHash, role: 'guest', isVerified: true }
  ]);
