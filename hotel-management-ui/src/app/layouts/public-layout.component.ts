          ...
          <div class="flex items-center gap-3">
            @if (user()) {
              ...
              <a
                ...
                class="inline-flex items-center justify-center px-5 py-2.5 rounded-full bg-amber-800 hover:bg-amber-900 text-white text-sm font-medium transition-all shadow-md shadow-amber-900/20 hover:shadow-lg hover:-translate-y-0.5 whitespace-nowrap"
              >
                Book your stay
              </a>
            }
