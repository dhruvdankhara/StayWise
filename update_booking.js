  ...
  template: \\\
    <div class="animate-fade-in pb-20 pt-6 text-left relative overflow-hidden min-h-screen">
      ...
      <div class="fixed inset-0 -z-10 pointer-events-none bg-neutral-50/50">
        <div class="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-amber-500/10 blur-[120px]"></div>
        <div class="absolute top-[20%] right-[5%] w-[40%] h-[40%] rounded-full bg-orange-500/10 blur-[100px]"></div>
      ...
      @if (booking\\$ | async; as booking) {
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <header class="mb-8 relative flex flex-col md:flex-row md:items-end justify-between gap-6 rounded-[2.5rem] border border-white/60 bg-white/70 backdrop-blur-2xl p-6 md:p-10 shadow-xl shadow-amber-900/5">
            <div>
              <div class="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-amber-100/80 border border-amber-200/50 mb-6 shadow-sm">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-10">
            ...
            <div class="lg:col-span-8 space-y-8">
              <article class="relative border border-white/80 shadow-2xl shadow-amber-900/5 rounded-[2.5rem] p-6 md:p-10 backdrop-blur-2xl bg-white/80 overflow-hidden group">
                <div class="absolute -top-32 -right-32 w-80 h-80 bg-amber-500/10 rounded-full blur-[80px] z-0 transition-transform duration-700 group-hover:scale-110"></div>

                <div class="relative z-10">
                  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-10 border-b border-neutral-200/60">
                    <div class="flex items-start md:items-center gap-6">
                      <div class="w-20 h-20 rounded-[1.5rem] bg-gradient-to-br from-amber-100 to-orange-50 border border-amber-200/50 flex items-center justify-center text-amber-700 shrink-0 shadow-inner">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                          <path d="M2 22h20"></path><path d="M4 2v20"></path><path d="M20 2v20"></path><path d="M10 22V8a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v14"></path><path d="M14 12V2h-4v10"></path>
                        </svg>
                      </div>
                      <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 py-10 border-b border-neutral-200/60">
                    <div class="bg-gradient-to-br from-orange-50/50 to-amber-50/30 border border-orange-100 rounded-[2rem] p-6 transition-all hover:shadow-md hover:border-orange-200">
                      <div class="flex items-center gap-4 mb-4">
                        <div class="w-12 h-12 rounded-xl bg-white border border-orange-100 flex items-center justify-center text-orange-600 shadow-sm">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                        </div>
                        <p class="text-sm font-bold text-neutral-500 uppercase tracking-widest">Stay Period</p>
                      </div>
                    ...
                    <div class="bg-gradient-to-br from-emerald-50/50 to-teal-50/30 border border-emerald-100 rounded-[2rem] p-6 flex flex-col justify-between transition-all hover:shadow-md hover:border-emerald-200">
                      <div class="flex items-center gap-4 mb-4">
                        <div class="w-12 h-12 rounded-xl bg-white border border-emerald-100 flex items-center justify-center text-emerald-600 shadow-sm">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
                        </div>
                        <p class="text-sm font-bold text-neutral-500 uppercase tracking-widest">Total Amount</p>
                      </div>
                      <div class="ml-2">
                  ...
                  <div class="pt-10">
                    <h3 class="text-xl font-bold text-neutral-900 mb-6 flex items-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-amber-600"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
                      Booking Information
                    </h3>
            ...
            <aside class="lg:col-span-4 flex flex-col gap-6 relative z-10 sticky top-24">
              ...
              <div class="grid grid-cols-1 gap-4">
                ...
                >
                  <span class="flex items-center gap-3">
                    <span class="p-2 bg-neutral-100 text-neutral-600 rounded-lg group-hover:bg-amber-100 group-hover:text-amber-600 transition-colors">
              ...
              >
                <div class="absolute -right-10 -top-10 text-amber-500/5 rotate-12 pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" viewBox="0 0 24 24" fill="currentColor"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                </div>

                <div class="flex items-center gap-4 mb-2 relative z-10">
                  <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 shadow-md shadow-amber-500/20 flex items-center justify-center text-white shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                  </div>
                  <div>
                    <h3 class="text-xl font-extrabold text-neutral-900 leading-tight">Leave a Review</h3>
                ...
                <div class="space-y-5 relative z-10">
                  <label class="flex flex-col gap-2.5">
                    ...
                    <div class="relative">
                      ...
                      />
                      <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none text-amber-500 fill-current">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                      </div>
                    </div>
                  </label>
                ...
                >
                  <span class="absolute inset-0 w-full h-full -translate-x-full bg-gradient-to-r from-transparent via-white/20 to-transparent group-hover:animate-shimmer"></span>
